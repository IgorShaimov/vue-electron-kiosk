<template>
  <div class="guest bg-secondary-blue">
    ...
    <div class="content">      
      ...
      <div class="content-bottom">
        <div class="description">Select what type of<br>Visitor are you?</div>
        <div class="items">
...
export default {
  ...
  methods: {
    ...
    goToVehicle() {
      ...
      setTimeout(() => {
        this.$router.push({ name: 'GuestVehicle' });
      }, 800);
    },
    goToNoneVehicle() {
      this.user_type = 'none-vehicle';
      setTimeout(() => {
        this.$router.push({ name: 'GuestNoVehicle' });
      }, 800);
    }
  }
}
