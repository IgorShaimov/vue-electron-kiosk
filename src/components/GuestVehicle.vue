<template>
  <div class="guest-vehicle bg-secondary-blue">
    <back-button @click="goBack()" color="white" />
    <home-button v-if="step === 9" />
    ...
    <transition name="titleLeft">
      <div class="title" v-if="step === 3">
        Phone number of the<br>person you're visiting
        <div class="sub-title">
          We will send a verification code
          <br />if the data matches our records
        </div>
      </div>
    </transition>
    <div
      class="title"
      v-if="step === 5 || step === 6 || step === 7 || step === 8"
    >
      Parking will expire at:
      <div class="sub-title">{{ formatDate(expires) }}</div>
    </div>
    <transition name="titleLeft">
      <div class="title stepper4" v-if="step === 9">
        Thank You!
        <div class="sub-title">
          Your visitor pass is printing.
          <br />Please collect it and put it on the <br />dash of your vehicle
          or share the <br />code with your visitor
        </div>
      </div>
    </transition>
    ...
    <transition name="contentLeft">
      <div class="enter-name-items" v-if="step === 1">
        <div class="description enter-name">Enter Name</div>
    ...
    <div class="content-bottom enter-name" v-if="step === 3">
    </div>
    <transition name="contentLeft">
      <div class="enter-name-items" v-if="step === 3">
        <div class="description enter-name">Enter Phone Number</div>
        <div class="items enter-name">
          <div class="item">
            <input placeholder="(603) 555-0123" class="normal" v-model="phone" type="text" @input="acceptNumber" />
          </div>
        </div>
      </div>
    </transition>
    ...
    <div class="action enter-name" v-if="step === 3">
      <div class="big-btn" @click="goToNext()">Send verification</div>
    </div>
    </transition>
    ...
    <div class="content-bottom" v-if="step === 5"></div>
    <transition name="contentRight">
      <div class="enter-name-items make" v-if="step === 5">
        <div class="description enter-name">Vehicle Make</div>
    ...
    <!-- step 6 Vehicle Color -->
    <div class="content" v-if="step === 6">
      <div class="buildings">
        <img src="@/assets/svg/buildings.svg" />
      </div>
    </div>
    <div class="content-bottom" v-if="step === 6"></div>
    <transition name="contentRight">
      <div class="enter-name-items make" v-if="step === 6">
    ...
    <transition name="contentUp1">
      <div class="content stepper3" v-if="step === 7">
        <div class="buildings">
          <img src="@/assets/svg/buildings.svg" />
        </div>
      </div>
    </transition>
    <div class="content-bottom stepper3" v-if="step === 7"></div>
    <transition name="contentRight">
      <div class="enter-name-items make" v-if="step === 7">
        <div class="description enter-name no-padding">
        ...
        <div class="list provinces">
          <div
            ...
            :key="index"
            :class="{'active': index === selectedProvince}"
            @click="selectedProvince = index"
          >{{ province }}</div>
        </div>
      </div>
    </transition>
    ...
    <!-- step 3 Comment -->
    <div class="content stepper3" v-if="step === 8">
      <div class="buildings">
        <img src="@/assets/svg/buildings.svg" />
      </div>
    </div>
    <div class="content-bottom stepper3" v-if="step === 8"></div>
    <transition name="contentRight">
      <div class="enter-name-items" v-if="step === 8">
    ...
    <div class="action enter-name" v-if="step === 8">
      <div
        class="big-btn"
        @click="goToNext()"
      >
    ...
    <transition name="contentDown">
      <div class="content stepper4" v-if="step === 9">
        <div class="buildings">
          <img src="@/assets/svg/buildings.svg" />
        </div>
    ...
    <div class="action enter-name" v-if="step === 9">
      <div
        class="big-btn"
        @click="
          stepper = 5;
  ...
  methods: {
    goBack() {
      ...
      if (this.step === 1) {
        ...
        if (this.step === 7) this.stepper = 2;
        if (this.step === 9) this.stepper = 3;
        --this.step;
      }
    },
    async goToNext() {
